<?php
    $breadcrumbs = [
        ...
        ['label' => $brand->name, 'url' => route('admin.brands.show', $brand)],
        ['label' => 'Edit', 'url' => null],
    ];
?>
        ...
        <form action="<?php echo e(route('admin.brands.update', $brand)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $brand->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="<?php echo e(old('slug', $brand->slug)); ?>"
                        class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="status" id="status"
                        class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                        <option value="active" <?php echo e(old('status', $brand->status) === 'active' ? 'selected' : ''); ?>>Active</option>
                        <option value="inactive" <?php echo e(old('status', $brand->status) === 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                    </select>
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\brands\edit.blade.php ENDPATH**/ ?>