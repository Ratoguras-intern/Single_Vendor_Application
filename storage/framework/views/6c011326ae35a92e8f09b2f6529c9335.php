    ...
    <div class="section">
        <div class="rounded-card p-12 text-center border border-primary-100 dark:border-primary-900 bg-gradient-to-r from-primary-50 to-primary-100/50 dark:from-primary-950/30 dark:to-primary-900/30">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="<?php echo e(route('frontend.contact')); ?>" class="btn-outline">
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\partials\newsletter.blade.php ENDPATH**/ ?>