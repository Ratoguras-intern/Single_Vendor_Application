...
<section class="py-12 sm:py-16 lg:py-20">
    <div class="section">
        <div class="text-center mb-12">
            <h2 class="section-heading"><?php echo e($section?->title ?? 'Why Choose Us'); ?></h2>
            <p class="section-subheading"><?php echo e($section?->subtitle ?? "We're committed to delivering the best experience"); ?></p>
        </div>
            ...
            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card-hover text-center group">
                    <div class="h-14 w-14 rounded-full bg-primary-50 dark:bg-primary-950/30 flex items-center justify-center mx-auto mb-4 group-hover:bg-primary-100 dark:group-hover:bg-primary-950/30 transition-colors">
                        ...
                        <?php elseif($feature['icon'] === 'delivery'): ?>
                        ...
                        <?php elseif($feature['icon'] === 'checkout'): ?>
                            <svg class="h-7 w-7 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z"/></svg>
                        <?php elseif($feature['icon'] === 'returns'): ?>
                    ...
                    <h3 class="font-semibold text-secondary-900 dark:text-white mb-2"><?php echo e($feature['title']); ?></h3>
                    <p class="text-sm text-secondary-500 dark:text-secondary-400 leading-relaxed"><?php echo e($feature['description']); ?></p>
                </div>
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\home\why-choose-us.blade.php ENDPATH**/ ?>