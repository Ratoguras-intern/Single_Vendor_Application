...
<div x-data="announcementBar()" x-cloak
    ...
    <div class="section flex items-center justify-center relative">
        ...
        <button x-on:click="dismiss()" class="absolute right-0 p-1 text-white/60 hover:text-white transition-colors" aria-label="Close announcement">
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\partials\announcement-bar.blade.php ENDPATH**/ ?>