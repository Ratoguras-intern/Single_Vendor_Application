...
<section class="relative py-16 sm:py-20 overflow-hidden">
    <img src="<?php echo e($bgImage); ?>" alt="Newsletter" class="absolute inset-0 w-full h-full object-cover" loading="lazy" />
    <div class="absolute inset-0 bg-secondary-900/80 backdrop-blur-sm"></div>

    <div class="section relative z-10">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl sm:text-4xl font-extrabold text-white tracking-tight"><?php echo e($section?->title ?? 'Stay in the Loop'); ?></h2>
            <p class="mt-4 text-lg text-secondary-300"><?php echo e($section?->subtitle ?? 'Subscribe to our newsletter for exclusive offers, new arrivals, and style inspiration.'); ?></p>
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views/frontend/home/newsletter-cta.blade.php ENDPATH**/ ?>