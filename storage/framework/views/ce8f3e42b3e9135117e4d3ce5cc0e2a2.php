<?php if(!empty($featuredBanners) && $featuredBanners->isNotEmpty()): ?>
    <?php $__currentLoopData = $featuredBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <section class="py-8 sm:py-10 lg:py-12 border-t border-secondary-200 dark:border-secondary-800"
            ...
            <div class="section">
                <a href="<?php echo e($banner->link ?? '#'); ?>" class="group relative block w-full overflow-hidden rounded-card bg-secondary-900 min-h-[200px] sm:min-h-[250px] lg:min-h-[300px]">
                    ...
                    <?php endif; ?>
                    <div class="absolute inset-0" <?php if($overlayStyle): ?> style="background: linear-gradient(to left, <?php echo e($overlayStyle); ?> 40%, transparent 100%);" <?php else: ?> class="absolute inset-0 bg-gradient-to-l from-black/60 via-black/20 to-transparent" <?php endif; ?>></div>
                    <div class="relative h-full flex items-center px-6 sm:px-10 lg:px-14 py-8 sm:py-10 <?php echo e($banner->text_alignment === 'right' ? 'justify-start' : ($banner->text_alignment === 'center' ? 'justify-center' : 'justify-end')); ?>">
                        <div class="max-w-xl flex flex-col <?php echo e($alignClass); ?>">
                            <?php if($banner->badge): ?>
                                <span class="inline-flex items-center rounded-full <?php echo e($banner->badge_color ?? 'bg-primary-500'); ?> px-3 py-1 mb-3 <?php echo e($banner->text_alignment === 'center' ? 'mx-auto' : ''); ?> <?php echo e($banner->text_alignment === 'right' ? 'ml-auto mr-0' : 'ml-0 mr-auto'); ?>">
                            ...
                            <?php elseif($banner->subtitle): ?>
                                <p class="mt-2 text-sm sm:text-base max-w-lg <?php echo e($textColor); ?>/80"><?php echo e($banner->subtitle); ?></p>
                            <?php endif; ?>
                            <?php if($banner->button_text || $banner->secondary_button_text): ?>
                                <div class="mt-4 flex flex-wrap gap-3 <?php echo e($banner->text_alignment === 'center' ? 'justify-center' : ''); ?> <?php echo e($banner->text_alignment === 'right' ? 'justify-end' : 'justify-start'); ?>">
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views/frontend/partials/banner-featured-section.blade.php ENDPATH**/ ?>