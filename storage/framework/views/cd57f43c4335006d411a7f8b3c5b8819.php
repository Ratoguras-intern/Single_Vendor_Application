    ...
    <?php $__currentLoopData = $toastMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $toast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div
            ...
            class="pointer-events-auto flex items-start gap-3 rounded-lg border p-4 shadow-lg backdrop-blur-sm
                <?php echo e($toast['type'] === 'success' ? 'border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-900/30' : ''); ?>

                <?php echo e($toast['type'] === 'error' ? 'border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/30' : ''); ?>

                <?php echo e($toast['type'] === 'warning' ? 'border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-900/30' : ''); ?>

                <?php echo e($toast['type'] === 'info' ? 'border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/30' : ''); ?>"
        >
            ...
            <p class="flex-1 text-sm font-medium
                <?php echo e($toast['type'] === 'success' ? 'text-green-800 dark:text-green-300' : ''); ?>

                <?php echo e($toast['type'] === 'error' ? 'text-red-800 dark:text-red-300' : ''); ?>

                <?php echo e($toast['type'] === 'warning' ? 'text-yellow-800 dark:text-yellow-300' : ''); ?>

                <?php echo e($toast['type'] === 'info' ? 'text-blue-800 dark:text-blue-300' : ''); ?>">
            ...
            <button @click="close($el.closest('[x-data]'))" class="shrink-0
                <?php echo e($toast['type'] === 'success' ? 'text-green-500 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300' : ''); ?>

                <?php echo e($toast['type'] === 'error' ? 'text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300' : ''); ?>

                <?php echo e($toast['type'] === 'warning' ? 'text-yellow-500 hover:text-yellow-700 dark:text-yellow-400 dark:hover:text-yellow-300' : ''); ?>

                <?php echo e($toast['type'] === 'info' ? 'text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300' : ''); ?>">
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views/admin/layouts/partials/toast.blade.php ENDPATH**/ ?>