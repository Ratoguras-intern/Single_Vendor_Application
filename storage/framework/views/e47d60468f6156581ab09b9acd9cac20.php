...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('admin.categories.store')); ?>" method="POST" enctype="multipart/form-data" x-data="{ featured: <?php echo e(old('featured') ? 'true' : 'false'); ?> }">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="seo_description" id="seo_description" rows="2"
                                class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white" placeholder="Meta description for search engines"><?php echo e(old('seo_description')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\categories\create.blade.php ENDPATH**/ ?>