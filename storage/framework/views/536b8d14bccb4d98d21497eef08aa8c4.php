...
<?php endif; ?>
                    ...
                    <p class="mb-6 max-w-sm text-sm text-secondary-500 dark:text-secondary-400 leading-relaxed"><?php echo e($companyDesc); ?></p>
                    ...
                    <div class="flex gap-3 mt-6">
                        <?php $__currentLoopData = $socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($social['url']); ?>" aria-label="<?php echo e($social['platform']); ?>" class="h-10 w-10 rounded-card bg-secondary-100 dark:bg-white/5 inline-flex items-center justify-center text-secondary-500 dark:text-secondary-400 hover:bg-primary-50 dark:hover:bg-primary-950/30 hover:text-primary-600 dark:hover:text-primary-300 transition-all duration-200">
                ...
                <?php $__currentLoopData = $footerColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <h4 class="text-sm font-semibold mb-4 uppercase tracking-wider text-secondary-900 dark:text-white"><?php echo e($col['heading']); ?></h4>
                        <ul class="space-y-2.5">
                            <?php $__currentLoopData = $col['links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="#" class="text-sm text-secondary-500 dark:text-secondary-400 hover:text-secondary-900 dark:hover:text-white transition-colors inline-block"><?php echo e($link); ?></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
        ...
        <div class="py-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <div class="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400">
                    <span>&copy; <?php echo e(date('Y')); ?> <?php echo e($companyName); ?>&trade;. <?php echo e($copyrightText); ?></span>
                </div>
                <p class="text-sm text-secondary-500 dark:text-secondary-400">Powered by <span class="font-bold text-primary-600 dark:text-primary-400"><?php echo e($companyName); ?></span></p>
            </div>
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\partials\footer.blade.php ENDPATH**/ ?>