...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('admin.categories.update', $category)); ?>" method="POST" enctype="multipart/form-data" x-data="{ featured: <?php echo e($category->featured ? 'true' : 'false'); ?> }">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white"><?php echo e(old('description', $category->description)); ?></textarea>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <?php if($category->banner_url): ?>
                                <div class="mb-2 relative group">
                                    <img src="<?php echo e($category->banner_url); ?>" alt="Banner" class="w-full h-24 rounded-lg object-cover">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php if($category->icon_url): ?>
                                <div class="mb-2 relative group">
                                    <img src="<?php echo e($category->icon_url); ?>" alt="Icon" class="w-16 h-16 rounded-lg object-cover">
                                    <label class="absolute bottom-1 right-1 flex items-center gap-1.5 text-xs bg-white/90 dark:bg-gray-900/90 rounded px-2 py-1 cursor-pointer">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="seo_title" id="seo_title" value="<?php echo e(old('seo_title', $category->seo_title)); ?>"
                                class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="seo_description" id="seo_description" rows="2"
                                class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white"><?php echo e(old('seo_description', $category->seo_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                    <p class="text-sm text-blue-700 dark:text-blue-300">This category has <?php echo e($category->children_count); ?> <?php echo e(Str::plural('subcategory', $category->children_count)); ?>.</p>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\categories\edit.blade.php ENDPATH**/ ?>