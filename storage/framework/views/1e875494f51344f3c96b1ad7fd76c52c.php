<div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-6 mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="url" name="config[bg_image]" value="<?php echo e(old('config.bg_image', $section->config['bg_image'] ?? '')); ?>"
        ...
        <div>
            ...
            <input type="text" name="config[button_text]" value="<?php echo e(old('config.button_text', $section->config['button_text'] ?? 'Subscribe')); ?>"
                class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
        </div>
    </div>
</div>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\homepage-sections\_newsletter-cta.blade.php ENDPATH**/ ?>