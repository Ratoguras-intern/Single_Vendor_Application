...
<?php endif; ?>
                    ...
                    <div class="pt-4 pb-1 border-t border-secondary-200 dark:border-secondary-700">
                        <div class="px-4">
                            <div class="font-medium text-base text-secondary-900 dark:text-white"><?php echo e(Auth::user()->name); ?></div>
                            <div class="font-medium text-sm text-secondary-500 dark:text-secondary-400"><?php echo e(Auth::user()->email); ?></div>
                        </div>
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\layouts\app.blade.php ENDPATH**/ ?>