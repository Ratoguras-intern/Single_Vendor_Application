<div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-6 mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="datetime-local" name="config[ends_at]" value="<?php echo e(old('config.ends_at', isset($section->config['ends_at']) ? date('Y-m-d\TH:i', strtotime($section->config['ends_at'])) : '')); ?>"
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\homepage-sections\_flash-sale.blade.php ENDPATH**/ ?>