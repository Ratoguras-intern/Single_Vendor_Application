...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.customers.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Customers</p>
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(number_format($totalCustomers)); ?></h4>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.products.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Products</p>
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(number_format($totalProducts)); ?></h4>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.categories.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Categories</p>
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(number_format($totalCategories)); ?></h4>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.brands.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Brands</p>
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(number_format($totalBrands)); ?></h4>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Orders</p>
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(number_format($totalOrders)); ?></h4>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.orders.index', ['status' => 'pending'])); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Pending Orders</p>
                        <h4 class="mt-1 text-2xl font-bold text-yellow-600"><?php echo e(number_format($pendingOrders)); ?></h4>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.orders.index', ['status' => 'completed'])); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Completed Orders</p>
                        <h4 class="mt-1 text-2xl font-bold text-green-600"><?php echo e(number_format($completedOrders)); ?></h4>
                    </div>
                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-green-50 text-green-600 dark:bg-green-500/10">
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.orders.index', ['status' => 'cancelled'])); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Cancelled Orders</p>
                        <h4 class="mt-1 text-2xl font-bold text-red-600"><?php echo e(number_format($cancelledOrders)); ?></h4>
                    </div>
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white">$<?php echo e(number_format($totalRevenue, 2)); ?></h4>
                    </div>
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white">$<?php echo e(number_format($revenueToday, 2)); ?></h4>
                    </div>
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white">$<?php echo e(number_format($revenueThisMonth, 2)); ?></h4>
                    </div>
        ...
        <div class="col-span-12 sm:col-span-6 xl:col-span-3">
            <a href="<?php echo e(route('admin.orders.index', ['payment_status' => 'paid'])); ?>" class="block rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Avg Order Value</p>
                        <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white">$<?php echo e(number_format($averageOrderValue, 2)); ?></h4>
                    </div>
    ...
    <div class="mt-6 flex flex-wrap items-center gap-3">
        ...
        <a href="<?php echo e(route('admin.products.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600 transition-colors">
        ...
        <a href="<?php echo e(route('admin.categories.create')); ?>" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-white/[0.03] dark:text-gray-300 dark:hover:bg-white/[0.06] transition-colors">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 5V19M5 12H19"/></svg>
            Add Category
        </a>
        <a href="<?php echo e(route('admin.brands.create')); ?>" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-white/[0.03] dark:text-gray-300 dark:hover:bg-white/[0.06] transition-colors">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 5V19M5 12H19"/></svg>
            Add Brand
        </a>
        <a href="<?php echo e(route('admin.orders.index')); ?>" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-white/[0.03] dark:text-gray-300 dark:hover:bg-white/[0.06] transition-colors">
        ...
        <a href="<?php echo e(route('admin.customers.index')); ?>" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-white/[0.03] dark:text-gray-300 dark:hover:bg-white/[0.06] transition-colors">
        ...
        <div class="col-span-12 xl:col-span-8">
            <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400 dark:hover:text-brand-300 font-medium">View All Orders &rarr;</a>
                </div>
        ...
        <div class="col-span-12 xl:col-span-4">
            <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400 dark:hover:text-brand-300 font-medium">View All &rarr;</a>
                </div>
                ...
                <?php else: ?>
                    <div class="flex flex-col items-center justify-center h-[350px] text-center">
                        ...
                        <a href="<?php echo e(route('admin.products.create')); ?>" class="inline-flex items-center gap-1.5 text-sm font-medium text-brand-500 hover:text-brand-600 dark:text-brand-400">
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.customers.index')); ?>" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400 dark:hover:text-brand-300 font-medium">View All &rarr;</a>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                            <?php $__empty_1 = true; $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                                    <td class="px-5 py-3 text-sm text-gray-500 dark:text-gray-400"><?php echo e($index + 1); ?></td>
                                    <td class="px-5 py-3">
                                        <a href="<?php echo e(route('admin.customers.show', $customer)); ?>" class="flex items-center gap-3 group">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-gray-800 dark:text-white group-hover:text-brand-500 dark:group-hover:text-brand-400"><?php echo e($customer->name); ?></p>
                                                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($customer->email); ?></p>
                                            </div>
                                        </a>
                                    </td>
                                    <td class="px-5 py-3 text-sm text-gray-600 dark:text-gray-400"><?php echo e($customer->orders_count); ?></td>
                                    <td class="px-5 py-3 text-sm font-medium text-gray-800 dark:text-white">$<?php echo e(number_format($customer->total_spent ?? 0, 2)); ?></td>
                                </tr>
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400 dark:hover:text-brand-300 font-medium">View All &rarr;</a>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                            <?php $__empty_1 = true; $__currentLoopData = $latestOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                                    <td class="px-5 py-3">
                                        <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-800 dark:text-blue-400">#<?php echo e($order->order_number); ?></a>
                                    </td>
                                    <td class="px-5 py-3">
                                        <?php if($order->user): ?>
                                            <a href="<?php echo e(route('admin.customers.show', $order->user)); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-brand-500 dark:hover:text-brand-400"><?php echo e($order->user->name); ?></a>
                                        <?php else: ?>
                                            <span class="text-sm text-gray-600 dark:text-gray-400">Guest</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-5 py-3 text-sm font-medium text-gray-800 dark:text-white">$<?php echo e(number_format($order->total_amount, 2)); ?></td>
                                    <td class="px-5 py-3">
                                    ...
                                    <td class="px-5 py-3 text-sm text-gray-500 dark:text-gray-400"><?php echo e($order->created_at->format('M d, Y')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $latestCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                                    ...
                                    <td class="px-5 py-3 text-sm text-gray-500 dark:text-gray-400">
                                        <?php echo e($customer->last_order_date ? \Carbon\Carbon::parse($customer->last_order_date)->format('M d, Y') : 'N/A'); ?>

                                    </td>
                                    <td class="px-5 py-3 text-sm text-gray-500 dark:text-gray-400"><?php echo e($customer->created_at->format('M d, Y')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (salesCtx) {
        ...
        const salesMonthKeys = <?php echo json_encode($salesLabels->keys()->values()); ?>;
        const ordersUrl = '<?php echo e(route("admin.orders.index")); ?>';
        ...
        new Chart(salesCtx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Revenue ($)',
                        data: <?php echo json_encode($salesRevenue->map(fn($v) => round($v, 2))); ?>,
                    ...
                    {
                        label: 'Orders',
                        data: <?php echo json_encode($salesOrderCount); ?>,
                        type: 'line',
            ...
            options: {
                ...
                onClick: function(event, elements) {
                    if (elements.length > 0) {
                        ...
                        const monthKey = Object.keys(<?php echo json_encode($salesData->toArray()); ?>)[index];
                        if (monthKey) {
    ...
    if (prodCtx) {
        const productData = <?php echo json_encode($topProducts->map(fn($item) => ['id' => $item->product_id, 'name' => Str::limit($item->product->name ?? 'Product #' . $item->product_id, 20), 'sold' => $item->total_sold])); ?>;
        new Chart(prodCtx, {
            type: 'bar',
            data: {
            ...
            options: {
                ...
                onClick: function(event, elements) {
                    if (elements.length > 0) {
                        ...
                        if (productId) {
                            window.location.href = '<?php echo e(url("admin/products")); ?>/' + productId;
                        }
                    }
                },
                onHover: function(event, elements) {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\dashboard\index.blade.php ENDPATH**/ ?>