...
<?php $__env->startSection('content'); ?>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <a href="<?php echo e(route('admin.customers.show', $customer)); ?>" class="inline-flex items-center gap-1 text-sm font-medium mb-2 text-blue-600 hover:text-blue-800 dark:text-blue-400">
            ...
            <h2 class="text-xl font-bold text-gray-800 dark:text-white">Orders by <?php echo e($customer->name); ?></h2>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                            ...
                            <td class="px-5 py-4 text-sm text-gray-600 dark:text-gray-400">$<?php echo e(number_format($order->subtotal, 2)); ?></td>
                            <td class="px-5 py-4 text-sm text-gray-600 dark:text-gray-400">$<?php echo e(number_format($order->tax, 2)); ?></td>
                            <td class="px-5 py-4 text-sm text-gray-600 dark:text-gray-400"><?php echo e($order->shipping > 0 ? '$' . number_format($order->shipping, 2) : 'Free'); ?></td>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\customers\orders.blade.php ENDPATH**/ ?>