<?php if(!empty($promotionalBanners) && $promotionalBanners->isNotEmpty()): ?>
    <?php $__currentLoopData = $promotionalBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <section class="py-8 sm:py-10 lg:py-12"
            ...
            <div class="section">
                <a href="<?php echo e($banner->link ?? '#'); ?>" class="group relative block w-full overflow-hidden rounded-card bg-secondary-900 min-h-[180px] sm:min-h-[220px] lg:min-h-[260px]">
                    ...
                    <?php endif; ?>
                    <div class="absolute inset-0" <?php if($overlayStyle): ?> style="background: linear-gradient(to right, <?php echo e($overlayStyle); ?> 40%, transparent 100%);" <?php else: ?> class="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent" <?php endif; ?>></div>
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views/frontend/partials/banner-promotional.blade.php ENDPATH**/ ?>