...
<?php endif; ?>
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-secondary-500">
            ...
            <a href="<?php echo e(route('login')); ?><?php echo e(request('redirect') ? '?redirect=' . urlencode(request('redirect')) : ''); ?>" class="font-medium text-primary-600 hover:text-primary-700">
                Sign in
            </a>
        </p>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\auth\register.blade.php ENDPATH**/ ?>