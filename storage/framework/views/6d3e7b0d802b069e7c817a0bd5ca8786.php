...
<?php endif; ?>
    ...
    <div class="mt-6 text-center">
        <a href="<?php echo e(route('login')); ?>" class="text-sm text-primary-600 hover:text-primary-700 font-medium">
            &larr; Back to login
        </a>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>