...
<meta property="og:image" content="<?php echo e($category->banner_url); ?>">
<?php endif; ?>
<?php $__env->stopPush(); ?>
...
<section class="relative overflow-hidden bg-gradient-to-br from-secondary-900 via-secondary-800 to-primary-900">
    <?php if($category->banner_url): ?>
        <img src="<?php echo e($category->banner_url); ?>" alt="<?php echo e($category->name); ?>" class="absolute inset-0 w-full h-full object-cover opacity-30" loading="lazy">
    <?php endif; ?>
    ...
    <div class="section relative py-12 sm:py-16 lg:py-20">
        ...
        <nav class="flex items-center gap-2 text-sm text-white/60 mb-6" aria-label="Breadcrumb">
            <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $crumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
                <?php if($crumb['url']): ?>
                    <a href="<?php echo e($crumb['url']); ?>" class="hover:text-white transition-colors"><?php echo e($crumb['name']); ?></a>
                <?php else: ?>
                    <span class="text-white" aria-current="page"><?php echo e($crumb['name']); ?></span>
                <?php endif; ?>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-6">
            <?php if($category->icon_url): ?>
                <img src="<?php echo e($category->icon_url); ?>" alt="<?php echo e($category->name); ?>" class="h-16 w-16 rounded-xl object-cover shadow-lg shrink-0 hidden sm:block">
            <?php endif; ?>
            <div class="flex-1">
                <div class="flex items-center gap-3 mb-2">
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight"><?php echo e($category->name); ?></h1>
                ...
                <?php if($category->description): ?>
                    <p class="text-white/70 max-w-2xl text-sm sm:text-base"><?php echo e($category->description); ?></p>
                <?php endif; ?>
                <div class="mt-4 flex items-center gap-4 text-sm text-white/60">
                    <span class="flex items-center gap-1.5">
                        ...
                        <?php echo e(number_format($products->total())); ?> Products
                    </span>
                    <?php if($children->isNotEmpty()): ?>
                        <span class="flex items-center gap-1.5">
                            ...
                            <?php echo e($children->count()); ?> Subcategories
                        </span>
                    <?php endif; ?>
                </div>
            </div>
            <a href="<?php echo e(route('frontend.shop')); ?>" class="btn-primary btn-lg shrink-0 self-start hidden sm:inline-flex">
    ...
    <div class="section">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('frontend.category', $child->slug)); ?>" class="group relative overflow-hidden rounded-card bg-white dark:bg-secondary-800 shadow-card hover:shadow-card-hover transition-all duration-200 hover:-translate-y-0.5">
                    <div class="aspect-[4/3] overflow-hidden bg-secondary-100 dark:bg-secondary-700">
                        <?php if($child->thumbnail_url): ?>
                            <img src="<?php echo e($child->display_image); ?>" alt="<?php echo e($child->name); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" loading="lazy">
                        <?php else: ?>
                    ...
                    <div class="p-4">
                        <h3 class="text-sm font-semibold text-secondary-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors"><?php echo e($child->name); ?></h3>
                        <p class="text-xs text-secondary-500 dark:text-secondary-400 mt-1"><?php echo e($child->products_count); ?> <?php echo e(Str::plural('product', $child->products_count)); ?></p>
...
<section class="py-8 sm:py-10 lg:py-12" x-data="{
    ...
    from: <?php echo e($products->firstItem() ?? 0); ?>,
    to: <?php echo e($products->lastItem() ?? 0); ?>,
    perPage: <?php echo e($products->perPage()); ?>,
    viewMode: localStorage.getItem('categoryView') || 'grid',
}">
    <div class="section">

        
        <?php echo $__env->make('frontend.partials.category-toolbar', [
        ...
        <div class="flex gap-8">
            ...
            <div class="hidden lg:block w-64 shrink-0 sticky top-24 self-start max-h-[calc(100vh-8rem)] overflow-y-auto scrollbar-hide">
                <?php echo $__env->make('frontend.partials.category-filters', [
                    'brands' => $brands,
                    'priceRange' => $priceRange,
                ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php echo $__env->make('frontend.partials.banner-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            ...
            <div class="flex-1 min-w-0">
                <?php if($products->count() > 0): ?>
                    ...
                    <div class="mt-10">
                        <?php echo $__env->make('frontend.partials.category-pagination', ['paginator' => $products], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                <?php else: ?>
                    ...
                    <div class="text-center py-20">
                        ...
                        <div class="flex items-center justify-center gap-3">
                            <?php if($activeFilterCount > 0): ?>
                                <a href="<?php echo e(route('frontend.category', $category->slug)); ?>" class="btn-primary">
...
<?php if(!empty($recommendations['trending']) && count($recommendations['trending']) > 1): ?>
<section class="py-10 sm:py-12 border-t border-secondary-200 dark:border-secondary-800">
    <div class="section">
        <div class="flex items-end justify-between mb-8">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-secondary-900 dark:text-white">Trending in <?php echo e($category->name); ?></h2>
        ...
        <div class="grid gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
            <?php $__currentLoopData = array_slice($recommendations['trending'], 0, 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('frontend.partials.product-card', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php if(!empty($recommendations['new_arrivals']) && count($recommendations['new_arrivals']) > 1): ?>
<section class="py-10 sm:py-12 border-t border-secondary-200 dark:border-secondary-800">
    <div class="section">
        <div class="flex items-end justify-between mb-8">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-secondary-900 dark:text-white">New Arrivals in <?php echo e($category->name); ?></h2>
                <p class="text-sm text-secondary-500 dark:text-secondary-400 mt-1">Fresh products just added</p>
            </div>
        </div>
        <div class="grid gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
            <?php $__currentLoopData = array_slice($recommendations['new_arrivals'], 0, 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('frontend.partials.product-card', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\category.blade.php ENDPATH**/ ?>