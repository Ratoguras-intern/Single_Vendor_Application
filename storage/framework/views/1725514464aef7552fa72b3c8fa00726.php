...
<aside id="sidebar"
    class="fixed flex flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 dark:text-gray-300 h-screen transition-all duration-300 ease-in-out z-[99999] border-r border-gray-200"
    x-data="{
        openSubmenus: {},
        init() {
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.brand-logo','data' => ['sidebar' => true,'subtitle' => 'ADMIN SUITE']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['sidebar' => true,'subtitle' => 'ADMIN SUITE']); ?>
...
<?php endif; ?>
    ...
    <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        ...
        <div x-data x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
            ...
            <?php echo $__env->make('admin.layouts.partials.sidebar-widget', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

    </div>
</aside>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\layouts\sidebar.blade.php ENDPATH**/ ?>