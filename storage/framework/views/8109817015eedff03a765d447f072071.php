<?php $__env->startSection('title', 'Shopping Cart - NBK Vertex'); ?>
    ...
    <div class="section">
        ...
        <div x-show="!$store.cart.loading && $store.cart.count() === 0" style="display: none;" class="py-32">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <h1 class="text-3xl font-bold text-secondary-900 dark:text-white mb-3" data-i18n="Your cart is empty" x-text="$store.i18n.t('Your cart is empty')"><?php echo e(__('Your cart is empty')); ?></h1>
                <p class="text-lg text-secondary-500 dark:text-secondary-400 mb-8" data-i18n="Looks like you haven't added anything to your cart yet." x-text="$store.i18n.t(&quot;Looks like you haven't added anything to your cart yet.&quot;)"><?php echo e(__("Looks like you haven't added anything to your cart yet.")); ?></p>

                <a href="<?php echo e(route('frontend.shop')); ?>" class="btn-primary">
                    <span data-i18n="Continue Shopping" x-text="$store.i18n.t('Continue Shopping')"><?php echo e(__('Continue Shopping')); ?></span>
                </a>
        ...
        <div x-show="!$store.cart.loading && $store.cart.count() > 0" style="display: none;">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="page-heading" data-i18n="Shopping Cart" x-text="$store.i18n.t('Shopping Cart')"><?php echo e(__('Shopping Cart')); ?></h1>
                    <p class="section-subheading mt-1">
                        <span x-text="$store.cart.count()"></span> <span data-i18n="item(s) in your cart" x-text="$store.i18n.t('item(s) in your cart')"><?php echo e(__('item(s) in your cart')); ?></span>
                    </p>
                </div>
                <a href="<?php echo e(route('frontend.shop')); ?>" class="btn-ghost btn-sm text-secondary-500 dark:text-secondary-400 hover:text-secondary-900 dark:hover:text-white">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2">
                    <div class="card p-0">
                        <div class="flex items-center justify-between p-6 pb-4">
                            <h2 class="text-lg font-semibold text-secondary-900 dark:text-white" data-i18n="Cart Items" x-text="$store.i18n.t('Cart Items')"><?php echo e(__('Cart Items')); ?></h2>
                            <button x-on:click="$store.cart.clear()" class="btn-ghost btn-sm text-secondary-400 dark:text-secondary-500 hover:text-red-500">
                                ...
                                <span data-i18n="Clear All" x-text="$store.i18n.t('Clear All')"><?php echo e(__('Clear All')); ?></span>
                            </button>
                        </div>
                ...
                <div class="lg:col-span-1">
                    <div class="card sticky top-24">
                        <h2 class="text-lg font-semibold text-secondary-900 dark:text-white mb-6" data-i18n="Order Summary" x-text="$store.i18n.t('Order Summary')"><?php echo e(__('Order Summary')); ?></h2>

                        <div class="space-y-4">
                            <div class="flex justify-between text-sm">
                                <span class="text-secondary-500 dark:text-secondary-400"><span data-i18n="Subtotal" x-text="$store.i18n.t('Subtotal')"><?php echo e(__('Subtotal')); ?></span> (<span x-text="$store.cart.count()"></span> <span data-i18n="items" x-text="$store.i18n.t('items')">items</span>)</span>
                            ...
                            <div class="flex justify-between text-sm">
                                <span class="text-secondary-500 dark:text-secondary-400"><span data-i18n="Shipping" x-text="$store.i18n.t('Shipping')"><?php echo e(__('Shipping')); ?></span></span>
                                <span class="font-medium text-secondary-900 dark:text-white">
                                    <template x-if="$store.cart.shipping === 0">
                                        <span class="badge-success"><span data-i18n="Free" x-text="$store.i18n.t('Free')"><?php echo e(__('Free')); ?></span></span>
                                    </template>
                                    <template x-if="$store.cart.shipping > 0">
                            ...
                            <div class="flex justify-between text-sm">
                                <span class="text-secondary-500 dark:text-secondary-400"><span data-i18n="Tax" x-text="$store.i18n.t('Tax')"><?php echo e(__('Tax')); ?></span></span>
                            ...
                            <div class="flex justify-between">
                                <span class="text-lg font-semibold text-secondary-900 dark:text-white"><span data-i18n="Total" x-text="$store.i18n.t('Total')"><?php echo e(__('Total')); ?></span></span>
                        ...
                        <a href="<?php echo e(route('frontend.checkout')); ?>" class="btn-primary w-full mt-6">
                            <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z"/></svg>
                            <span data-i18n="Proceed to Checkout" x-text="$store.i18n.t('Proceed to Checkout')"><?php echo e(__('Proceed to Checkout')); ?></span>
                        </a>
                        ...
                        <div class="space-y-3 pt-6 mt-6 border-t border-secondary-200 dark:border-secondary-700">
                            <div class="flex items-center gap-3 text-sm text-secondary-500 dark:text-secondary-400">
                                ...
                                <span data-i18n="Secure SSL checkout" x-text="$store.i18n.t('Secure SSL checkout')"><?php echo e(__('Secure SSL checkout')); ?></span>
                            </div>
                            <div class="flex items-center gap-3 text-sm text-secondary-500 dark:text-secondary-400">
                                ...
                                <span data-i18n="Free returns within 30 days" x-text="$store.i18n.t('Free returns within 30 days')"><?php echo e(__('Free returns within 30 days')); ?></span>
                            </div>
                            <div class="flex items-center gap-3 text-sm text-secondary-500 dark:text-secondary-400">
                                ...
                                <span data-i18n="24/7 customer support" x-text="$store.i18n.t('24/7 customer support')"><?php echo e(__('24/7 customer support')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-16">
                <div class="card">
                    <h2 class="text-lg font-semibold text-secondary-900 dark:text-white mb-4" data-i18n="You might also like" x-text="$store.i18n.t('You might also like')"><?php echo e(__('You might also like')); ?></h2>
                    <div class="text-center py-8">
                        <p class="text-secondary-500 dark:text-secondary-400 mb-4" data-i18n="Discover more products that match your style" x-text="$store.i18n.t('Discover more products that match your style')"><?php echo e(__('Discover more products that match your style')); ?></p>
                        <a href="<?php echo e(route('frontend.shop')); ?>" class="btn-outline">
                            <span data-i18n="Browse Products" x-text="$store.i18n.t('Browse Products')"><?php echo e(__('Browse Products')); ?></span>
                        </a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\cart.blade.php ENDPATH**/ ?>