    ...
    <div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="p-6">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <p class="text-sm text-gray-800 dark:text-white"><?php echo e($brand->name); ?></p>
                </div>

                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-500 dark:text-gray-400">Slug</label>
                    <p class="text-sm text-gray-800 dark:text-white"><?php echo e($brand->slug); ?></p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-800 dark:text-white"><?php echo e($brand->products_count ?? 0); ?></p>
                </div>

                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-500 dark:text-gray-400">Logo</label>
                    <?php if($brand->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $brand->logo)); ?>" alt="<?php echo e($brand->name); ?>" class="h-20 w-20 rounded-lg object-cover">
                    <?php else: ?>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-800 dark:text-white"><?php echo e($brand->created_at->format('M d, Y h:i A')); ?></p>
                </div>

                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-500 dark:text-gray-400">Updated At</label>
                    <p class="text-sm text-gray-800 dark:text-white"><?php echo e($brand->updated_at->format('M d, Y h:i A')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="border-t border-gray-200 px-6 py-4 dark:border-gray-800">
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.brands.edit', $brand)); ?>" class="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600">
                    Edit Brand
                </a>
                <form action="<?php echo e(route('admin.brands.destroy', $brand)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this brand?')">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\admin\brands\show.blade.php ENDPATH**/ ?>