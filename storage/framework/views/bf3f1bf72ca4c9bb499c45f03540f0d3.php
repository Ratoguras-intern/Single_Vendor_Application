<div x-data="{ open: false }" class="relative">
    <button @click="open = !open"
        ...
        <span class="hidden text-right lg:block">
            <span class="block text-sm font-semibold text-gray-800 dark:text-white"><?php echo e(Auth::user()->name ?? 'Admin'); ?></span>
            <span class="block text-xs text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->role ?? 'admin'); ?></span>
        </span>
    ...
    <div x-show="open" @click.away="open = false" x-transition
        ...
        <div class="px-4 py-2 border-b border-gray-100 dark:border-gray-800">
            <p class="text-sm font-semibold text-gray-800 dark:text-white"><?php echo e(Auth::user()->name ?? 'Admin'); ?></p>
            <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->email ?? ''); ?></p>
        </div>
        <div class="py-1">
            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-white/[0.03]">
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views/header/user-dropdown.blade.php ENDPATH**/ ?>