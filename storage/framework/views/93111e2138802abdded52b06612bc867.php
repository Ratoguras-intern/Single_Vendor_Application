...
<?php if(!empty($recommendedProducts) && count($recommendedProducts) > 0): ?>
<section class="py-12 sm:py-16 lg:py-20">
    <div class="section">
        <div class="flex items-end justify-between mb-10">
            <div>
                <h2 class="section-heading"><?php echo e($section?->title ?? 'Recommended For You'); ?></h2>
                <p class="section-subheading"><?php echo e($section?->subtitle ?? 'Picked based on popular taste'); ?></p>
            </div>
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            <?php $__currentLoopData = array_slice($recommendedProducts, 0, $section?->max_products ?? 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views/frontend/home/recommended-products.blade.php ENDPATH**/ ?>