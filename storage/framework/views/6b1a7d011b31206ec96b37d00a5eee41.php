...
<?php if(!empty($flashSaleProducts) && count($flashSaleProducts) > 0): ?>
<section
    x-data="{
        endDate: <?php echo e($endTimestamp); ?> * 1000,
        now: Date.now(),
    ...
    class="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-secondary-900 via-secondary-800 to-secondary-900"
>
    <div class="section">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-8 mb-10">
            <div class="text-center lg:text-left">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-white tracking-tight"><?php echo e($section?->title ?? "Don't Miss Out"); ?></h2>
                <p class="mt-2 text-lg text-secondary-300"><?php echo e($section?->subtitle ?? 'Limited time offers on selected products.'); ?></p>
            </div>
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            <?php $__currentLoopData = array_slice($flashSaleProducts, 0, $section?->max_products ?? 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-8 text-center">
            <a href="<?php echo e(route('frontend.shop')); ?>" class="btn-primary btn-lg inline-flex">
                Shop the Sale
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\home\flash-sale.blade.php ENDPATH**/ ?>