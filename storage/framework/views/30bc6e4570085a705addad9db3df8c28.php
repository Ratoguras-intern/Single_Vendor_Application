...
<?php endif; ?>
            ...
            <div class="flex items-center justify-between">
                <label for="remember_me" class="inline-flex items-center">
                    ...
                    <span class="ms-2 text-sm text-secondary-600"><?php echo e(__('Remember me')); ?></span>
                </label>
    ...
    <div class="mt-6 text-center">
        <p class="text-sm text-secondary-500">
            ...
            <a href="<?php echo e(route('register')); ?><?php echo e(request('redirect') ? '?redirect=' . urlencode(request('redirect')) : ''); ?>" class="font-medium text-primary-600 hover:text-primary-700">
                Create account
            </a>
        </p>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\auth\login.blade.php ENDPATH**/ ?>