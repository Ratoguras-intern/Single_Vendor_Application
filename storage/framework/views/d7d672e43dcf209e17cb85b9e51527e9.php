...
<nav class="section pt-6 pb-2" aria-label="Breadcrumb">
    <ol class="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400">
        <li><a href="<?php echo e(route('frontend.home')); ?>" class="hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Home</a></li>
        <li>/</li>
...
<div class="shop-layout" x-data="xShop(<?php echo e($products->total()); ?>, <?php echo e($products->firstItem() ?? 0); ?>, <?php echo e($products->lastItem() ?? 0); ?>, <?php echo e($products->perPage()); ?>)">
    ...
    <div class="shop-content" x-data="{ viewMode: localStorage.getItem('shopView') || 'grid' }">
        ...
        <div id="shop-products">
            <?php echo $__env->make('frontend.partials.shop-products-content', [
                'products' => $products,
                'viewMode' => $viewMode,
                'ajax' => true,
            ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\shop.blade.php ENDPATH**/ ?>