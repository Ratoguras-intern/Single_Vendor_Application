    ...
    <div class="max-h-[320px] overflow-y-auto">
        <template x-if="$store.cart.count() === 0">
            <div class="flex flex-col items-center justify-center py-10 px-5">
                ...
                <a href="<?php echo e(route('frontend.shop')); ?>" class="mt-3 text-sm font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">Start Shopping</a>
            </div>
        </template>
...
<?php /**PATH D:\Co_laravel\Single Vendor Ecomm\single-vendor-ecommerce\resources\views\frontend\partials\cart-dropdown.blade.php ENDPATH**/ ?>