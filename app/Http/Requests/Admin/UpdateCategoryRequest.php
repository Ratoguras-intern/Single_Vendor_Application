...
class UpdateCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'image' => ['nullable', 'image', 'max:' . (config('categories.image.main.max_size_kb') ?? 10240)],
            ...
            'remove_banner_mobile_image' => ['sometimes', 'boolean'],
            'image_media_id' => ['nullable', 'integer', 'exists:media,id'],
            'banner_image_media_id' => ['nullable', 'integer', 'exists:media,id'],
            'banner_mobile_image_media_id' => ['nullable', 'integer', 'exists:media,id'],
