    ...
    <div class="section">
        ...
        <div class="card p-0 overflow-hidden">
            @forelse ($orders as $order)
                <a href="{{ route('customer.orders.show', $order) }}" class="flex items-center justify-between p-5 border-b border-secondary-100 dark:border-secondary-700 transition-colors hover:bg-secondary-50 dark:hover:bg-white/5 last:border-b-0">
