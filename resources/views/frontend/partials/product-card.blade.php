...
<div x-data="{}" class="group flex flex-col h-full rounded-card bg-white dark:bg-secondary-900 border border-secondary-200 dark:border-secondary-800 hover:border-secondary-300 dark:hover:border-secondary-600 hover:shadow-card-hover transition-all duration-200 overflow-hidden">
