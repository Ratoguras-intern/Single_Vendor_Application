    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <form method="POST" action="{{ route('admin.returns.destroy', $return) }}" onsubmit="return confirm('Delete this return permanently?')">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="inline-flex items-center gap-2 rounded-lg border border-red-300 bg-white px-4 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 dark:border-red-700 dark:bg-white/[0.03] dark:text-red-400 dark:hover:bg-red-500/10">
