                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" id="footer-toggle" role="switch" aria-checked="{{ old('show_in_footer', $page->show_in_footer ? '1' : '0') === '1' ? 'true' : 'false' }}"
                                class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 {{ old('show_in_footer', $page->show_in_footer ? '1' : '0') === '1' ? 'bg-brand-500' : 'bg-gray-300 dark:bg-gray-600' }}">
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div>
                        @if ($page->featured_image)
                            <div class="mb-3">
                                <img src="{{ $page->featured_image_url }}" alt="{{ $page->title }}" class="h-32 w-full rounded-lg object-cover">
                                <label class="mt-2 flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                    <input type="checkbox" name="remove_featured_image" value="1" class="rounded border-gray-300 text-brand-500 focus:ring-brand-500">
