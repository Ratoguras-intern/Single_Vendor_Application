    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                <div>
                    <x-media-picker.picker name="gallery_media_ids" label="Images (max 5)" :multiple="true" :max="5"
                        folder="products"
                        help="Select from the media library or upload new images. The first image becomes the primary product image." />
