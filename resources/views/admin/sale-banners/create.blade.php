...
@php
    ...
    $banner = $saleBanner ?? null;
@endphp

@section('content')
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-800 dark:text-white">Create Sale Banner</h2>
    </div>
                    ...
                    <div class="space-y-6">
                        <div x-data
                            ...
                            <x-media-picker.picker name="image_media_id" label="Background Image" folder="banners"
                                help="Recommended width: 1920px. The image is scaled down automatically after upload." />
                    ...
                    <div class="space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="text" name="badge" id="badge" value="{{ old('badge', 'FLASH SALE') }}" placeholder="FLASH SALE"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                            </div>
                            <div>
                                ...
                                <select name="badge_color" id="badge_color"
                                    class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                                    <option value="bg-green-500" {{ old('badge_color') === 'bg-green-500' ? 'selected' : '' }}>Green</option>
                                    ...
                                    <option value="bg-red-500" {{ old('badge_color', 'bg-red-500') === 'bg-red-500' ? 'selected' : '' }}>Red</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div>
                                ...
                                <select name="text_color" id="text_color"
                                    ...
                                    <option value="text-white" {{ old('text_color', 'text-white') === 'text-white' ? 'selected' : '' }}>White</option>
