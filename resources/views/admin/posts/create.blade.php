...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-800 dark:text-white">Create Post</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Write a new blog article with publishing and SEO options.</p>
        </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="mt-1.5 flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-500">
                                <span>URL preview: <span id="slug-preview" class="font-medium text-gray-600 dark:text-gray-300">/blog/post-slug</span></span>
                            </div>
                            @error('slug')
                                <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" id="excerpt" rows="2"
                                class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white @error('excerpt') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror"
                                placeholder="Short summary shown in blog listings">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
