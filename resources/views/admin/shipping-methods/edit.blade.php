...
@php
    $breadcrumbs = [
        ...
        ['label' => $shippingMethod->name, 'url' => null],
        ['label' => 'Edit', 'url' => null],
    ];
@endphp
...
@section('content')
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-800 dark:text-white">Edit Shipping Method</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update the delivery option details.</p>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03] max-w-2xl">
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $shippingMethod->name) }}" required
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-900 dark:text-white @error('description') border-red-500 @enderror">{{ old('description', $shippingMethod->description) }}</textarea>
                    @error('description')
                        <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', $shippingMethod->price) }}" min="0" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="text" name="delivery_estimate" id="delivery_estimate" value="{{ old('delivery_estimate', $shippingMethod->delivery_estimate) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="availability" id="availability" value="{{ old('availability', $shippingMethod->availability) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $shippingMethod->sort_order) }}" min="0"
                ...
                <div class="flex items-center justify-between rounded-lg border border-gray-200 p-4 dark:border-gray-800">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" @checked(old('is_active', $shippingMethod->is_active))
