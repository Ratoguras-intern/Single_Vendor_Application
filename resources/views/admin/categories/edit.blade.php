            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        {{-- Icon picker --}}
                        <div x-data="categoryIconPicker('{{ old('icon', $category->icon ?? '') }}')">
                            ...
                            <div>
                                ...
                                <select name="banner_image_fit" id="banner_image_fit"
                                    ...
                                    @foreach($objectFits as $fit)
                                        <option value="{{ $fit }}" {{ old('banner_image_fit', $category->banner_image_fit ?? 'cover') === $fit ? 'selected' : '' }}>{{ ucfirst($fit) }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="banner_image_position" id="banner_image_position"
                                    ...
                                    @foreach($objectPositions as $position)
                                        <option value="{{ $position }}" {{ old('banner_image_position', $category->banner_image_position ?? 'center') === $position ? 'selected' : '' }}>{{ ucfirst($position) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
