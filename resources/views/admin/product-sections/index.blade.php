...
@section('content')
    ...
    <!-- Available Products -->
    <div id="search-results" class="mb-8 rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="flex items-center justify-between border-b border-gray-200 px-5 py-3 dark:border-gray-800">
            <h3 class="text-sm font-semibold text-gray-800 dark:text-white">Assigned {{ $sectionLabel }} ({{ $assigned->total() }})</h3>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
